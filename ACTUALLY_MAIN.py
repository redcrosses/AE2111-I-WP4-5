...
design3: object = main2((loads_positive, loads_negative), spanwise_position, (n_positive, n_negative), 0.12079, 0.06808, 0.01, 0.015, 2, 10, 0.04, 0.04, 0.001, 0.001) #loads, span positions, loading factors,  front spar length, rear spar length, horizontal spar thickness, vertical spar thickness, rib spacing [m], number of stringers #last four are dimensions of an L stringer; width, height, width thickness, height thickness [m]
